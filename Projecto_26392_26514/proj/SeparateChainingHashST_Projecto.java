 ...
 * @param <Value>
 */
public class SeparateChainingHashST_Projecto<Key, Value> {
     ...
     */
    public SeparateChainingHashST_Projecto() {
        this(INIT_CAPACITY);
    } 
     ...
     */
    public SeparateChainingHashST_Projecto(int M) {
        this.M = M;
    ...
    private void resize(int chains) {
        SeparateChainingHashST_Projecto<Key, Value> temp = new SeparateChainingHashST_Projecto<Key, Value>(chains);
        for (int i = 0; i < M; i++) {
